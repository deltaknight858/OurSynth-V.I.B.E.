...
export interface HaloButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  label?: string; // optional convenience for simple buttons
}

// NOTE: Variant styling intentionally uses utility classes (tailwind-like).
// Future: migrate to design tokens (CSS vars) once token seed is introduced.
