...
__export(index_exports, {
  capsuleTools: () => capsuleTools,
  tools: () => tools,
  toolsCapsule: () => capsuleTools
});
...
// src/tools.capsule.ts
var import_child_process = require("child_process");
var import_util4 = require("util");
var run = (0, import_util4.promisify)(import_child_process.execFile);
var capsuleTools = [
  {
    name: "capsule.pack",
    description: "Pack current app into a signed Capsule",
    input: external_exports.object({
      appDir: external_exports.string(),
      manifestPath: external_exports.string(),
      outPath: external_exports.string()
    }),
    async run(p) {
  ...
  },
  {
    ...
    input: external_exports.object({
      ...
      env: external_exports.enum(["dev", "staging", "prod"]).default("staging")
    }),
    async run(p) {
