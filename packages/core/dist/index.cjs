...
__export(index_exports, {
  FocusRing: () => FocusRing,
  GenerateWithPathways: () => GenerateWithPathways,
  HaloButton: () => HaloButton,
  MeshCapsules: () => MeshCapsules,
  PromptForm: () => PromptForm,
  ScrollArea: () => ScrollArea,
  TimeMachine: () => TimeMachine,
  WizardStream: () => WizardStream,
  useAgentSession: () => useAgentSession
});
module.exports = __toCommonJS(index_exports);

// src/components/system/HaloButton.tsx
...
// src/components/system/HaloButton.tsx
var baseStyles = "relative inline-flex items-center justify-center font-medium rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 transition-all duration-200 gap-2 select-none disabled:opacity-50 disabled:cursor-not-allowed";
var sizeStyles = {
...
var HaloButton = import_react24.default.forwardRef(({
  variant = "primary",
  size = "md",
  loading = false,
  leftIcon,
  ...
  return /* @__PURE__ */ import_react24.default.createElement(
    ...
    {
      ref,
      whileTap: !disabled && !loading ? { scale: 0.97 } : void 0,
      className: clsx_default(baseStyles, sizeStyles[size], variantStyles[variant], className),
    ...
    loading ? /* @__PURE__ */ import_react24.default.createElement("span", { className: "animate-pulse" }, "Loading...") : /* @__PURE__ */ import_react24.default.createElement(import_react24.default.Fragment, null, leftIcon && /* @__PURE__ */ import_react24.default.createElement("span", { className: "inline-flex items-center", "aria-hidden": true }, leftIcon), content && /* @__PURE__ */ import_react24.default.createElement("span", null, content), rightIcon && /* @__PURE__ */ import_react24.default.createElement("span", { className: "inline-flex items-center", "aria-hidden": true }, rightIcon))
  );
});
...
function useStore(api, selector = identity) {
  const slice = import_react25.default.useSyncExternalStore(
    api.subscribe,
    import_react25.default.useCallback(() => selector(api.getState()), [api, selector]),
    import_react25.default.useCallback(() => selector(api.getInitialState()), [api, selector])
  );
  import_react25.default.useDebugValue(slice);
  return slice;
}
...
// src/state/agent/agentSessionStore.ts
var useAgentSession = create((set, get) => ({
  messages: [],
  status: "idle",
...
// ../halo-ui/primitives/focus-ring.tsx
var import_react26 = __toESM(require("react"));
var FocusRing = ({ inset = false, radius = 6, ...rest }) => {
  return /* @__PURE__ */ import_react26.default.createElement("div", { "data-halo-focus": true, "data-inset": inset ? "true" : "false", "data-radius": radius, className: "halo-focus-ring", ...rest });
};
...
// ../halo-ui/primitives/scroll-area.tsx
var import_react27 = __toESM(require("react"));
var ScrollArea = ({ height = 240, children }) => {
  const styleVar = typeof height === "number" ? `${height}px` : height;
  return /* @__PURE__ */ import_react27.default.createElement("div", { className: "halo-scroll-area", "data-halo-scroll": true, "data-maxh": styleVar }, children);
};
...
// src/components/capsules/MeshCapsules.tsx
var import_react28 = require("react");
function MeshCapsules() {
  const [files, setFiles] = (0, import_react28.useState)([]);
  (0, import_react28.useEffect)(() => {
    fetch("http://mesh.local:7423/capsules").then((r2) => r2.json()).then(setFiles);
  }, []);
  return /* @__PURE__ */ React.createElement("div", { className: "p-4 rounded-xl border border-cyan-400/30" }, /* @__PURE__ */ React.createElement("h3", { className: "text-cyan-300 font-semibold mb-2" }, "LAN Capsules"), /* @__PURE__ */ React.createElement("ul", { className: "space-y-1 text-sm text-gray-300" }, files.map((f) => /* @__PURE__ */ React.createElement("li", { key: f }, f))));
}

// src/components/lib/useOAIEvents.ts
function useOAIEvents() {
  return [];
}

// src/components/capsules/TimeMachine.tsx
var import_react29 = require("react");
function isCapsuleData(x) {
  return !!x && typeof x === "object";
}
function TimeMachine() {
  const events = useOAIEvents();
  const [selected, setSelected] = (0, import_react29.useState)(null);
  const timeline = (0, import_react29.useMemo)(() => events.filter((e) => /(run|edit|capsule)\./.test(e.type)).sort((a, b) => a.ts - b.ts), [events]);
  async function promoteToDeploy(evtId) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "p-4 rounded-xl bg-[rgba(10,12,20,0.7)] backdrop-blur-lg border border-cyan-400/30" }, /* @__PURE__ */ React.createElement("h3", { className: "text-cyan-300 font-semibold mb-3" }, "Time Machine"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 overflow-x-auto py-2" }, timeline.map((e) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: e.id,
    ...
    /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, new Date(e.ts).toLocaleTimeString()),
    /* @__PURE__ */ React.createElement("div", { className: "text-sm" }, e.source, " \u2022 ", e.type.replace(/^.*\./, ""))
...
// src/components/store/GenerateWithPathways.tsx
var import_react30 = require("react");
var getStartWizard = () => null;
function useSupabaseUser() {
  return { user: null };
}
function GenerateWithPathways({ product, isEntitled }) {
  const { user } = useSupabaseUser();
  const [open, setOpen] = (0, import_react30.useState)(false);
  const [isRunning, setIsRunning] = (0, import_react30.useState)(false);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    "button",
    {
      className: `mt-2 px-4 py-2 rounded-lg font-semibold transition shadow-[0_0_10px_rgba(34,211,238,0.35)] ${isEntitled ? "bg-cyan-400 text-black hover:brightness-110" : "bg-neutral-800 text-cyan-300 hover:bg-neutral-700"}`,
      onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("h3", { className: "text-xl font-semibold text-cyan-300 mb-2" }, "Generate ", product.title),
      /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-300" }, "This will scaffold files into your monorepo. You can preview diffs and apply via PR."),
      /* @__PURE__ */ React.createElement(
        "button",
        {
...
// src/components/wizard/PromptForm.tsx
var import_react32 = require("react");

// src/components/wizard/WizardStream.tsx
var import_react31 = require("react");
function WizardStream({ runId }) {
  const [status, setStatus] = (0, import_react31.useState)(null);
  const [done, setDone] = (0, import_react31.useState)(false);
  const liveRef = (0, import_react31.useRef)(null);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "rounded-2xl border border-cyan-400/30 bg-[rgba(20,20,30,0.85)] p-4 text-white backdrop-blur-xl" }, /* @__PURE__ */ React.createElement("h4", { className: "text-cyan-300 font-semibold mb-2" }, "Generating with Pathways"), /* @__PURE__ */ React.createElement(AnimatePresence, null, status && /* @__PURE__ */ React.createElement(
    motion.div,
    {
      key: status.phase,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "text-sm mb-2" }, "Phase: ", /* @__PURE__ */ React.createElement("span", { className: "text-cyan-200" }, phases[status.phase] ?? status.phase)),
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-1 rounded bg-cyan-400/10 border border-cyan-400/30" }, status.fileCount, " files"), /* @__PURE__ */ React.createElement("span", { className: "px-2 py-1 rounded bg-cyan-400/10 border border-cyan-400/30" }, status.elapsed, "s elapsed"), status.errors?.length ? /* @__PURE__ */ React.createElement("span", { className: "px-2 py-1 rounded bg-red-400/10 border border-red-400/40 text-red-300" }, "Error") : null),
    /* @__PURE__ */ React.createElement("div", { className: "mt-3 h-1 w-full rounded bg-neutral-700 overflow-hidden" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        className: `h-1 transition-all ${done ? "w-full bg-cyan-400" : "w-1/3 animate-pulse bg-cyan-500"}`
      }
    ))
  )), /* @__PURE__ */ React.createElement(
    "div",
...
// src/components/wizard/PromptForm.tsx
function PromptForm({ defaultProductSlug = "", defaultType = "component" }) {
  const [name, setName] = (0, import_react32.useState)(defaultProductSlug);
  const [goal, setGoal] = (0, import_react32.useState)("");
  const [type, setType] = (0, import_react32.useState)(defaultType);
  const [runId, setRunId] = (0, import_react32.useState)(null);
  const [busy, setBusy] = (0, import_react32.useState)(false);
  const [err, setErr] = (0, import_react32.useState)(null);
  async function onSubmit(e) {
    e.preventDefault();
    setBusy(true);
    setErr(null);
    try {
      const r2 = await fetch("/api/pathways/start", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          productSlug: name,
      ...
      if (!r2.ok) throw new Error(json.error || "Failed");
      setRunId(json.runId);
    } catch (e2) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "rounded-2xl border border-cyan-400/30 bg-[rgba(20,20,30,0.85)] p-4 text-white backdrop-blur-xl" }, /* @__PURE__ */ React.createElement("form", { onSubmit, className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "pf-name", className: "block text-sm text-cyan-200 mb-1" }, "Template or slug"), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: "pf-name",
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "pf-goal", className: "block text-sm text-cyan-200 mb-1" }, "Goal / description"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      id: "pf-goal",
      className: "w-full rounded-lg bg-black/30 border border-cyan-400/30 px-3 py-2 outline-none focus:border-cyan-300",
      ...
      rows: 3,
      placeholder: "Add a responsive login page with OAuth"
    }
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "pf-type", className: "block text-sm text-cyan-200 mb-1" }, "Type"), /* @__PURE__ */ React.createElement(
    "select",
    {
      id: "pf-type",
      className: "w-full rounded-lg bg-black/30 border border-cyan-400/30 px-3 py-2 outline-none focus:border-cyan-300",
    ...
    /* @__PURE__ */ React.createElement("option", { value: "component" }, "Component"),
    /* @__PURE__ */ React.createElement("option", { value: "page" }, "Page"),
    /* @__PURE__ */ React.createElement("option", { value: "feature" }, "Feature"),
    /* @__PURE__ */ React.createElement("option", { value: "app" }, "App")
  )), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "submit",
  ...
  ), err && /* @__PURE__ */ React.createElement("p", { className: "text-red-300 text-sm" }, err)), runId && /* @__PURE__ */ React.createElement("div", { className: "mt-4" }, /* @__PURE__ */ React.createElement(WizardStream, { runId })));
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  FocusRing,
  GenerateWithPathways,
  HaloButton,
  MeshCapsules,
  PromptForm,
  ScrollArea,
